...
namespace Swordfish.Library.Networking
{
    public class NetStatsRecord
    {
        ...
        public NetStatsRecord Clone() => new NetStatsRecord()
        {
            BytesIn = BytesIn,
        ...
        public static NetStatsRecord operator +(NetStatsRecord left, NetStatsRecord right) => new NetStatsRecord()
        {
