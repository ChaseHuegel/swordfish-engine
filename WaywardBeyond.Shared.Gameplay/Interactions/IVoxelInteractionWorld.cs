...
/// mutable voxel container + transform so the resolver can validate reach and occupancy. Validation never
/// raycasts - the client's screen-aim targeting produced the hint.
/// </summary>
