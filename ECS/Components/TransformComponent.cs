    ...
    public struct TransformComponent
    {
        ...
        public int parent {
            ...
            set {
                ...
                {
                    localPosition += Engine.ECS.Get<TransformComponent>(_parent).position;
                    localOrientation += Engine.ECS.Get<TransformComponent>(_parent).orientation;
                }
        ...
        public Vector3 position {
            get {
                if (parent == Entity.Null)
                    ...
                    return localPosition + Engine.ECS.Get<TransformComponent>(parent).position;
            }
            ...
            set {
                if (parent == Entity.Null)
                    ...
                    localPosition = value - Engine.ECS.Get<TransformComponent>(parent).position;
            }
        }
        ...
        public Quaternion orientation {
            get {
                if (parent == Entity.Null)
                    ...
                    return localOrientation + Engine.ECS.Get<TransformComponent>(parent).orientation;
            }
            ...
            set {
                if (parent == Entity.Null)
                    ...
                    localOrientation = value - Engine.ECS.Get<TransformComponent>(parent).orientation;
            }
        }
    }
}
