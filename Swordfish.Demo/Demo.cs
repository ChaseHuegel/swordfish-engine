...
namespace Swordfish.Demo
{
    public class Demo
    {
        ...
        public static void CreateEntityParented(Vector3 pos, Quaternion rot)
        {
            ...
            Entity child1 = Swordfish.Engine.Swordfish.ECS.CreateEntity("childEntity", "",
                    new RenderComponent() { mesh = null },
                    new RigidbodyComponent() { mass = 10, restitution = 1f, drag = 3f, resistance = 1f, velocity = Vector3.Zero },
                    new CollisionComponent() { size = 0.5f },
            ...
            Entity child2 = Swordfish.Engine.Swordfish.ECS.CreateEntity("childEntity", "",
                    new RenderComponent() { mesh = null },
                    new RigidbodyComponent() { mass = 10, restitution = 1f, drag = 3f, resistance = 1f, velocity = Vector3.Zero },
                    new CollisionComponent() { size = 0.5f },
                    new TransformComponent() { parent = parent, localPosition = new Vector3(0, -1, 0), orientation = rot }
            ...
            //  TODO properly implement parent-child relationship on entities
            Swordfish.Engine.Swordfish.ECS.Do<TransformComponent>(parent, x => {
                x.children.Add(child1);
                x.children.Add(child2);
                return x;
            });
        }

        public static void CreateEntity(Vector3 pos, Quaternion rot)
        {
            Swordfish.Engine.Swordfish.ECS.CreateEntity("floatingCube", "",
                    new RenderComponent() { mesh = null },
                    new RigidbodyComponent() { mass = 1f, restitution = 1f, drag = 3f, resistance = 1f },
                    new CollisionComponent() { size = 0.5f },
                    new TransformComponent() { position = pos, orientation = rot },
                    new TurntableComponent()
                );
        ...
        public static void CreateEntityCube(Vector3 pos, Quaternion rot)
        {
            Swordfish.Engine.Swordfish.ECS.CreateEntity("fallingCube", "",
                    new RenderComponent() { mesh = null },
        ...
        public static void CreateEntityCubes(int count)
        {
        ...
        public static void CreateBillboardEntity(Shader shader, Texture texture, Vector3 position, Vector3 scale)
        {
        ...
        public static void CreatePointLightEntity(Vector3 position, Vector4 color, float lumens)
        {
            if (Swordfish.Engine.Swordfish.ECS.CreateEntity(out Entity entity))
            {
                Mesh mesh = new Quad();
        ...
        public static void CreateAnimatedBoardEntity(Shader shader, Texture texture, float speed, Vector3 position, Vector3 scale)
        {
            if (Swordfish.Engine.Swordfish.ECS.CreateEntity(out Entity entity))
            {
        ...
        {
            Debug.Enabled = true;
            Swordfish.Engine.Swordfish.ECS.RegisterAssembly();
